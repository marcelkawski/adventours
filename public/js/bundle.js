...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibWthd3NraSIsImEiOiJjbDkwMXpmMzUwcTB1M3dtdHFvZWI1MzM1In0.vyKhzArskXL3bsfq4ubimQ';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          passwordConfirm = document.getElementById('password-confirm').value; // await is to wait until the password is updated and then perform some other actions.
          _context.next = 7;
